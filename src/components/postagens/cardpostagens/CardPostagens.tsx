      ...
      <div className='border-slate-900 border flex flex-col rounded overflow-hidden justify-between'>
        <div>
          <div className="flex w-full bg-indigo-400 py-2 px-4 items-center gap-4">
            <img src='https://i.imgur.com/Zz4rzVR.png' className='h-12 rounded-full' alt="" />
            <h3 className='text-lg font-bold text-center uppercase '>Usuário - Nome</h3>
          </div>
          <div className='p-4 '>
            <h4 className='text-lg font-semibold uppercase'>Título</h4>
            <p>Texto</p>
            <p>Tema: Tema - Descrição</p>
